...
pub fn builtin_sector() -> SectorMetadata {
    SectorMetadata {
        ...
        spawn_points: vec![
            NamedPoint { name: "stand_1".into(), point: WorldPoint { x_nm: -0.195, y_nm: -0.225 } },
            NamedPoint { name: "stand_2".into(), point: WorldPoint { x_nm: -0.195, y_nm: -0.175 } },
            NamedPoint { name: "stand_3".into(), point: WorldPoint { x_nm: -0.195, y_nm: -0.125 } },
            NamedPoint { name: "stand_4".into(), point: WorldPoint { x_nm: -0.195, y_nm: -0.075 } },
            NamedPoint { name: "stand_5".into(), point: WorldPoint { x_nm: -0.195, y_nm: -0.025 } },
            NamedPoint { name: "stand_6".into(), point: WorldPoint { x_nm: -0.195, y_nm: 0.025 } },
            NamedPoint { name: "stand_7".into(), point: WorldPoint { x_nm: -0.195, y_nm: 0.075 } },
            NamedPoint { name: "stand_8".into(), point: WorldPoint { x_nm: -0.195, y_nm: 0.125 } },
            NamedPoint { name: "stand_9".into(), point: WorldPoint { x_nm: -0.195, y_nm: 0.175 } },
            NamedPoint { name: "stand_10".into(), point: WorldPoint { x_nm: -0.195, y_nm: 0.225 } },
            NamedPoint { name: "hold_18".into(), point: WorldPoint { x_nm: 0.0, y_nm: 0.329 } },
            NamedPoint { name: "hold_36".into(), point: WorldPoint { x_nm: 0.0, y_nm: -0.329 } },
            NamedPoint { name: "taxi_main_south".into(), point: WorldPoint { x_nm: -0.12, y_nm: -0.345 } },
            NamedPoint { name: "taxi_main_north".into(), point: WorldPoint { x_nm: -0.12, y_nm: 0.345 } },
            ...
            NamedPoint { name: "taxi_main_northbound".into(), point: WorldPoint { x_nm: -0.12, y_nm: 0.12 } },
            NamedPoint { name: "exit_a_to_main".into(), point: WorldPoint { x_nm: -0.12, y_nm: -0.345 } },
            NamedPoint { name: "exit_b_to_main".into(), point: WorldPoint { x_nm: -0.12, y_nm: -0.060 } },
            NamedPoint { name: "exit_c_to_main".into(), point: WorldPoint { x_nm: -0.12, y_nm: 0.060 } },
            NamedPoint { name: "exit_d_to_main".into(), point: WorldPoint { x_nm: -0.12, y_nm: 0.345 } },
        ],
    }
}
